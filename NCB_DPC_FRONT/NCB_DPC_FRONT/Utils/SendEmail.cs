...
namespace NCB_DPC_FRONT.Utils
{
    class SendEmail
    {
        ...
        public static void sendEmail(ApplicationModel application)
        {
            ...
            sb.AppendLine("<br><br><b>Application for Digital Proficiency Course</b>");
            ...
            try
            {
                 ...
                 )
                {
                    ...
                    mail.To.Add(emailReceiveraddress);
